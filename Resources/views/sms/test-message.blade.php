<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">تست ارسال پیام</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <x-forms.tel fieldId="mobile" :fieldLabel="__('app.mobile')" fieldName="mobile"
                                     :fieldValue="$user->mobile" fieldPlaceholder="شماره موبایل بدون 0"></x-forms.tel>
                    </div>
                    <div class="col-lg-2">
                        <x-forms.select fieldId="phone_code" fieldLabel=" کشور" fieldName="phone_code"
                                        search="true">
